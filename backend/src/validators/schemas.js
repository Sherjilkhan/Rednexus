...
export const donorRegistrationSchema = z
  .object({
    ...
    phone: z.string().regex(/^[0-9+\-\s]{8,15}$/, 'Enter a valid phone number').optional().or(z.literal('')),
    area_pincode: z.string().regex(/^\d{6}$/, 'Enter a 6-digit PIN code').optional().or(z.literal('')),
